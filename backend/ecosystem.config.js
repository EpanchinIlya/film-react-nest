...
module.exports = {
  ...
  deploy: {
    production: {
      ...
      //'pre-deploy': `scp C:/Users/Work/.ssh/id_rsa_pm2 C:/Project/film-react-nest/backend/.env ${DEPLOY_USER}@${DEPLOY_HOST}:${DEPLOY_PATH}/backend`,
      'pre-deploy':
        'scp -i C:/Users/Work/.ssh/id_rsa_pm2 C:/Project/film-react-nest/backend/.env zoiberg@158.160.179.204:/home/zoiberg/film-react-nest_pm2_deploy/current/backend',
